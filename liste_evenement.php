...
<div class="container">
  <div class="row">
    <div class="col-lg-8">
        ...
        <?php 
         foreach ($detail as $key => $evenement)
          {
        ...
        <div class="row">
          ...
          <div class="col-lg-8" style="border-left: 5px solid blue">
            <a href="evenement.php?id=<?php echo $evenement['id']; ?>">
              <b><?php echo $evenement['titre']; ?></b></a>
            <br><b><i class="fa fa-user">&nbsp;</i><?php echo $evenement['auteur']; ?></b>
          </div>
        </div>
        <br>
        <div class="row">
          <div class="col-lg-4">
            <a href="evenement.php?id=<?php echo $evenement['id']; ?>">
            <img src="album/<?php echo $evenement['image']; ?>" width="200" height="150" />
            </a>
          </div>
          <div class="col-lg-8">
            <a href="evenement.php?id=<?php echo $evenement['id']; ?>">
              <b><?php echo $evenement['description']; ?>....</b>
            </a>
          </div>
        </div><hr>
