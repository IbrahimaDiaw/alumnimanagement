...
$id = $_GET['id'];
$detail = $alumni->detail_evenement($id);
               ...
               <?php 
                ...
                <div class="sub-heard-part">
									   <ol class="breadcrumb m-b-0">
											...
											<li class="active">détail événements</li>
										</ol>
									   </div>
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           <center>Détail événement</center> 
                        </h1>
                    </div>
                </div>
                <div class="panel panel-primary">
                	<div class="panel panel-header"><center><strong>Titre événement :</strong><?php echo $v['titre']; ?></center></div>
