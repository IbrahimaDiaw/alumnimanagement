...
$id = $_GET['id'];
$liste = $alumni->detail_actualite($id);
  ...
  <div class="row">
    <div class="col-lg-8">
        <div class="abt-w3l">
           <div class="header-w3l">
            <h3 class="page-header">
              Détail compplet de l'actualité&nbsp;
        ...
        <?php 
         ...
         <div class="image">
          <div class="row">
          	<div class="col-lg-4" style="border:2px solid gray;">

         	<img src="album/<?php echo $actualite['image'] ?>" style="width: 200px;">
         	</div>
         	<div class="col-lg-8" >
             ...
             <label style="padding-left: 300px;" >
             	Auteur :
      <b style="text-transform: uppercase;"><?php echo $actualite['auteur'] ?></b><br>
             	Publié en :
